...
option_list <- list(
  ...
  make_option(c("--db-dir"), type = "character", default = "db",
              metavar = "DIR",
              help = "Directory containing BFD.duckdb [default: %default]"),
  make_option(c("--db-name"), type = "character", default = "BFD.duckdb",
              metavar = "FILE",
