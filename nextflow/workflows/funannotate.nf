...
workflow FUNANNOTATE {
    ...
    // out -> ASMIDs that should skip PASA/RNA-seq training outright and go straight
    // to ab-initio-only prediction, regardless of ani_to_representative (see
    // loadRnaseqSkipSet(), pasaTierFor() in FUNANNOTATE_RNASEQ.nf). Empty set
