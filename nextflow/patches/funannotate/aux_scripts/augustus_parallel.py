...
def runAugustus(Input):
    ...
    # BFD_Fungi fix (2026-09-18): upstream computes this unconditionally, so a
    # predict run with zero protein/RNA-seq evidence (no --hints passed to this
    ...
    # executes. Confirmed against Neopereziidae_sp._gmOTU29_Ox002475
    # (funannotate-1.9.0-beta.11.sif, 2026-09-18): 0/463 chunks completed,
    # 463/463 failed instantly. Only compute it when hints were actually given.
